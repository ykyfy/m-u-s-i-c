let media="https://gcore.jsdelivr.net/gh/ykyfy/music@main/media/"
...
// let requestJson="https://music.yangxiaohan.ip-ddns.com/memp.json"
...
Player.prototype = {
  ...
  play: function(index) {
    ...
    document.title=data.title + " - music";//显示浏览器TAB栏内容
...
console.log("\n %c music v3.7 %c https://music.yangxiaohan.ip-ddns.com \n", "color: #fff; background-image: linear-gradient(90deg, rgb(47, 172, 178) 0%, rgb(45, 190, 96) 100%); padding:5px 1px;", "background-image: linear-gradient(90deg, rgb(45, 190, 96) 0%, rgb(255, 255, 255) 100%); padding:5px 0;");
